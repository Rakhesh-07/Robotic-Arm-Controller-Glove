...
// Most of this is derived from the sample code in the library
// Adjusted to fit 4 flex sensors and pitch, yaw, roll in one string
...
void BLEServerPackage::sendData(const char* messages[], uint8_t numStrings) {
  ...
  char buffer[128] = {0}; // Adjust if more data needs to be sent
  ...
  // Print in serial to read without ITA or motors
  Serial.print("Sent: ");
